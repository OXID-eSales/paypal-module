[{if $oViewConf->isPayPalCheckoutActive()}]
    ...
    [{include file='@osc_paypal/frontend/shared/layout/base_paypal_payment_controller_config.tpl'}]
    [{include file='@osc_paypal/frontend/shared/layout/base_paypal_button_config.tpl'}]
[{/if}]
