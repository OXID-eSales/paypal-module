[{$smarty.block.parent}]
[{if method_exists($oViewConf, 'showPayPalCheckoutBannerOnProductDetailsPage') && $oViewConf->showPayPalCheckoutBannerOnProductDetailsPage()}]
    ...
    [{/if}]
    [{include file="@osc_paypal/frontend/installment_banners.tpl" amount=$bannerAmount selector=$oViewConf->getPayPalCheckoutBannerProductDetailsPageSelector()}]
[{/if}]
