...
$aLang = array_merge(
    ...
    'OSC_PAYPAL_EXPRESS_LOGIN_TITLE'              => 'Automatischer Login',
    ...
    'OSC_PAYPAL_MERCHANT_COUNTRY'                 => 'Land Ihres PayPal-Kontos',
    'OSC_PAYPAL_MERCHANT_COUNTRY_UNKNOWN'         => '<em>noch nicht abgefragt - speichern Sie diese Konfiguration einmal, dann holt das Modul das Land Ihres Kontos bei PayPal ab.</em>',
    'OSC_PAYPAL_SPECIAL_PAYMENTS_ACDC_COUNTRY'    => '<em>- PayPal bietet die Kreditkartenzahlung (ACDC) im Land Ihres PayPal-Kontos (%s) nicht an. Die Zahlart und das Hinterlegen von Karten sind deshalb ausgeblendet, auch wenn Ihr PayPal-Konto die Berechtigung dafür meldet. Maßgeblich ist das Land des Kontos, nicht das Land Ihres Shops: auch ein Shop in einem anderen Land kann über dieses Konto keine Kreditkarten abrechnen.</em>',
    'OSC_PAYPAL_SPECIAL_PAYMENTS_ACDC_COUNTRY_UNKNOWN' => '<em>- PayPal bietet die Kreditkartenzahlung (ACDC) im Land Ihres Shops (%s) nicht an. Die Zahlart und das Hinterlegen von Karten sind deshalb ausgeblendet. Das Land Ihres PayPal-Kontos ist noch nicht bekannt, und maßgeblich ist eigentlich dieses: speichern Sie diese Konfiguration einmal, damit es bei PayPal abgefragt wird - liegt Ihr Konto in einem Land mit Kreditkartenzahlung, steht die Zahlart danach wieder zur Verfügung.</em>',
    ...
    'OSC_PAYPAL_CANCEL_REFUND_TITLE'                => 'Storno und Rückerstattung',
    'OSC_PAYPAL_AUTOMATED_REFUND_ON_CANCEL'         => 'Beim Storno einer Bestellung automatisch erstatten',
    'HELP_OSC_PAYPAL_AUTOMATED_REFUND_ON_CANCEL'    => 'Ist diese Option aktiv, erstattet der Shop beim Storno einer Bestellung im Backend den noch offenen Betrag der PayPal-Zahlung — also den eingezogenen Betrag abzüglich bereits erstatteter Teilbeträge. Ist nichts (mehr) offen oder wurde nie eingezogen, passiert nichts. Scheitert die Rückerstattung, bleibt das Storno trotzdem bestehen: Sie sehen eine Fehlermeldung und können die Rückerstattung über den Rückerstattungs-Button im PayPal-Reiter der Bestellung nachholen. Ohne diese Option verhält sich das Modul wie bisher — das Storno lässt die Zahlung bei PayPal unberührt.',
    'OSC_PAYPAL_CANCEL_REFUND_FAILED'               => 'Die automatische Rückerstattung zu dieser Bestellung ist fehlgeschlagen. Das Storno wurde ausgeführt; bitte lösen Sie die Rückerstattung im PayPal-Reiter der Bestellung von Hand aus. Details stehen im PayPal-Log.',
    ...
    'HELP_OSC_PAYPAL_CANCEL_MAIL'                   => 'Wer wird per E-Mail informiert, wenn eine PayPal-Bestellung im Backend storniert wurde? Wurde dabei automatisch erstattet (Option "Beim Storno einer Bestellung automatisch erstatten"), nennt diese Mail auch den erstatteten Betrag — der Kunde bekommt dann eine Mail statt zwei. Ohne automatische Rückerstattung bestätigt sie nur die Stornierung, und eine später von Hand ausgelöste Rückerstattung wird separat bestätigt.',
    'OSC_PAYPAL_MAIL_RECIPIENT_NONE'                => 'Keine Mail versenden',
    'OSC_PAYPAL_MAIL_RECIPIENT_CUSTOMER'            => 'An den Kunden',
    'OSC_PAYPAL_MAIL_RECIPIENT_OWNER'               => 'An den Shop-Betreiber',
    'OSC_PAYPAL_MAIL_RECIPIENT_BOTH'                => 'An Kunden und Shop-Betreiber',
    ]
);
