            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           class="form-control"
                           name="filters[oscpaypal_subscription][paypalbillingagreementid]"
                           value="[{if $filters.oscpaypal_subscription.paypalbillingagreementid}][{$filters.oscpaypal_subscription.paypalbillingagreementid}][{/if}]">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           class="form-control"
                           name="filters[oscpaypal_subscription_product][paypalsubscriptionplanid]"
                           value="[{if $filters.oscpaypal_subscription_product.paypalsubscriptionplanid}][{$filters.oscpaypal_subscription_product.paypalsubscriptionplanid}][{/if}]">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
        ...
        <table class="table table-sm">
            ...
            <tbody>
                [{foreach from=$subscriptions item="subscription" name="subscriptions"}]
                    ...
                    <tr class="[{$cellClass}]">
                        <td>[{$subscription->oscpaypal_subscription__paypalbillingagreementid->value}]</td>
                        <td>[{$subscription->oscpaypal_subscription__paypalsubscriptionplanid->value}]</td>
                        <td>[{$subscription->oscpaypal_subscription__oxbillemail->value}]</td>
                        <td>[{$subscription->oscpaypal_subscription__oxorderdate->value}]</td>
                        <td>
                            <a href="[{$detailsLink|cat:"&amp;billingagreementid="|cat:$subscription->oscpaypal_subscription__paypalbillingagreementid->value}]">
