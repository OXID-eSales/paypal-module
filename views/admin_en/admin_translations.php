...
$aLang = array_merge(
    ...
    'OSC_PAYPAL_MERCHANT_COUNTRY'                 => 'Country of your PayPal account',
    'OSC_PAYPAL_MERCHANT_COUNTRY_UNKNOWN'         => '<em>not fetched yet - save this configuration once and the module asks PayPal for the country of your account.</em>',
    'OSC_PAYPAL_SPECIAL_PAYMENTS_ACDC_COUNTRY'    => '<em>- PayPal does not offer card payments (ACDC) in the country of your PayPal account (%s). The payment method and storing cards are therefore hidden, even though your PayPal account reports the eligibility for it. What counts is the country of the account, not the country of your shop: a shop in another country cannot charge cards through this account either.</em>',
    'OSC_PAYPAL_SPECIAL_PAYMENTS_ACDC_COUNTRY_UNKNOWN' => '<em>- PayPal does not offer card payments (ACDC) in your shop\'s country (%s). The payment method and storing cards are therefore hidden. The country of your PayPal account is not known yet, and that is the one that actually counts: save this configuration once to have it fetched from PayPal - if your account sits in a country with card payments, the payment method is available again afterwards.</em>',
    ...
    'OSC_PAYPAL_CANCEL_REFUND_TITLE'                => 'Cancellation and refund',
    'OSC_PAYPAL_AUTOMATED_REFUND_ON_CANCEL'         => 'Refund automatically when an order is cancelled',
    'HELP_OSC_PAYPAL_AUTOMATED_REFUND_ON_CANCEL'    => 'With this option on, cancelling an order in the backend refunds what the PayPal payment still holds - the captured amount minus anything refunded before. If nothing is left to refund, or the payment was never captured, nothing happens. Should the refund fail, the cancellation still stands: you get an error message and can issue the refund by hand with the refund button in the PayPal tab of the order. Without this option the module behaves as before and a cancellation leaves the payment at PayPal untouched.',
    'OSC_PAYPAL_CANCEL_REFUND_FAILED'               => 'The automated refund for this order failed. The cancellation was carried out; please issue the refund by hand in the PayPal tab of the order. The details are in the PayPal log.',
    ...
    'HELP_OSC_PAYPAL_CANCEL_MAIL'                   => 'Who is notified by email once a PayPal order was cancelled in the backend? If the cancellation refunded automatically (option "Refund automatically when an order is cancelled"), this mail states the refunded amount as well, so the customer gets one mail instead of two. Without the automated refund it confirms the cancellation only, and a refund issued by hand later is confirmed separately.',
    'OSC_PAYPAL_MAIL_RECIPIENT_NONE'                => 'Do not send a mail',
    'OSC_PAYPAL_MAIL_RECIPIENT_CUSTOMER'            => 'To the customer',
    'OSC_PAYPAL_MAIL_RECIPIENT_OWNER'               => 'To the shop owner',
    'OSC_PAYPAL_MAIL_RECIPIENT_BOTH'                => 'To customer and shop owner',
    ]
);
