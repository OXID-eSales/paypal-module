...
<div id="card_container" class="card_container">
    <form id="pui_form">
        <div class="form-group row oxDate [{if !$iBirthdayMonth || !$iBirthdayDay || !$iBirthdayYear || $isUnder18}]text-danger[{else}]text-success[{/if}]">
            ...
            <div class="offset-lg-3 col-lg-9 col-12">
                ...
                <div class="help-block">
                    <p id="age-error-message" class="text-danger [{if !$isUnder18}]d-none[{/if}]">
