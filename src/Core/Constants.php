...
class Constants
{
    ...
    public const SESSION_CANCEL_DECLINE_ISSUE = 'oscpaypal-cancel-decline-issue';
    ...
    public const PAYPAL_PROCESSING_INSTRUCTIONS = 'ORDER_COMPLETE_ON_PAYMENT_APPROVAL';
    ...
    public const PAYPAL_PARTNER_ATTRIBUTION_ID_PPCP = 'OXID_Cart_PPCP_fromv380';
