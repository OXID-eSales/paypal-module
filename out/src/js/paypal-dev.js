window.OxidPayPalGooglePayStorage = {}
...
window.OxidPayPalGooglePay = {
    ...
    onShopOrderCreated: function (e) {
        window.OxidPayPalGooglePayStorage.currentOrder = e.detail;
    ...
    onGooglePaymentButtonClicked: async function () {
        const payPalPaymentControllerConfigurator = new PayPalPaymentControllerConfigurator();

        const shopOrderCreateUrl = payPalPaymentControllerConfigurator.shopOrderCreateUrl;
        const deliveryAddressId = payPalPaymentControllerConfigurator.deliveryAddressId;
        const body = {
            'deliveryAddressId': deliveryAddressId
        }
        let response = await fetch(shopOrderCreateUrl, {
            method: 'post',
    ...
    processPayment: async function (paymentDataAttr) {
        try {
            ...
            const paymentData = {
                ...paymentDataAttr,
                shopOrderId: window.OxidPayPalGooglePayStorage.currentOrder.shopOrderId
            };
