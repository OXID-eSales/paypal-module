...
test.describe('Payment Methods Tests', () => {
    ...
    test.beforeAll(async ({ browser }) => {
        ...
        page.setDefaultTimeout(30000); // Applies action timeouts globally
        page.setDefaultNavigationTimeout(30000); // Applies specifically to navigation calls
        await page.goto(process.env.BASE_URL);
    });

    test.beforeEach(async () => {
        page.setDefaultTimeout(30000); // Set Playwright default action timeout to 30 seconds
