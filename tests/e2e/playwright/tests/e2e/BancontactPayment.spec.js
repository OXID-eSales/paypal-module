...
test('Bancontact Failed Payment method', async () => {
    const shopHelper = new ShopHelper(page);
    const uAPMHelper = new UAPMHelper(page);
    await shopHelper.loginUser();
    await shopHelper.changeCountry('Belgium');
...
test('Bancontact Cancelled Payment method', async () => {
...
test('Bancontact without accepting T&C', async () => {
    const shopHelper = new ShopHelper(page);
    const uAPMHelper = new UAPMHelper(page);
    await shopHelper.loginUser();
    await shopHelper.changeCountry('Belgium');
